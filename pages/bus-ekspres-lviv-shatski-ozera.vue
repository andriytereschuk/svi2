  ...
  <div class="container bus-page">
    <div class="cols">
      <div class="cols-left">
        ...
        <ul class="b-prices">
          <li><i>350 грн</i> до Світязя, Шацька.</li>
          <li>
            <i>400 грн</i> до Гряди, Медик, "Лісова Пісня", пансіонат "Шацькі
        ...
        <ul class="b-prices red-prices">
          <li><i>250 грн</i> до Світязя, Шацька.</li>
          <li>
            <i>300 грн</i> до Гряди, Медик, "Лісова Пісня", пансіонат "Шацькі
            озера", Мельники, Пульмо.
          </li>
        </ul>
        ...
        <ul class="b-prices">
          <li><i>180 грн</i> до Світязя, Шацька.</li>
          <li>
            <i>230 грн</i> до Гряди, Медик, "Лісова Пісня", пансіонат "Шацькі
            озера", Мельники, Пульмо.
          </li>
        </ul>
        ...
        <ul class="b-prices red-prices">
          <li><i>150 грн</i> до Світязя, Шацька.</li>
          <li>
            <i>200 грн</i> до Гряди, Медик, "Лісова Пісня", пансіонат "Шацькі
            озера", Мельники, Пульмо.
          </li>
        </ul>
