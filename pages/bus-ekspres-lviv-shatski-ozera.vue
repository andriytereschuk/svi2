    ...
    <div class="container bus-page">
      <div class="cols">
        <div class="cols-left">
          ...
          <ul class="b-prices">
            <li>
              <i>600 грн</i> до Світязя, Шацька, Гряди, пансіонат "Шацькі
              озера".
            </li>
            <li><i>650 грн</i> Мельники, Гаївка (Лісова пісня).</li>
            <li><i>700 грн</i> Медик, Пульмо.</li>
          </ul>

          <h2>Ціни з Шептицький</h2>

          <ul class="b-prices red-prices">
            <li>
              <i>450 грн</i> до Світязя, Шацька, Гряди, пансіонат "Шацькі
              озера".
            </li>
            <li><i>500 грн</i> Мельники, Гаївка (Лісова пісня).</li>
            <li><i>550 грн</i> Медик, Пульмо.</li>
          </ul>
        ...
        <ul class="b-prices">
          ...
          <li>
            <i>280 грн</i> до Гряди, Медик, "Лісова Пісня", пансіонат "Шацькі
        ...
        <ul class="b-prices red-prices">
          <li><i>200 грн</i> до Світязя, Шацька.</li>
          <li>
            <i>250 грн</i> до Гряди, Медик, "Лісова Пісня", пансіонат "Шацькі
            озера", Мельники, Пульмо.
          </li>
        </ul> -->
