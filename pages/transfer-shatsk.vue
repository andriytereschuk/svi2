...
export default {
  ...
  head: {
    title:
      'Пасажирські перевезення з Шацька, ближніх сіл - по району та Україні',
    meta: [
      {
        hid: 'description',
        name: 'description',
        content:
          'Замовлення, оренда буса, автобуса для поїздок по Шацькому району та всередині країни',
      },
      {
        property: 'og:site_name',
        content: 'Бус на замовлення | Шацьк',
      },
      {
        property: 'og:url',
        content: 'https://www.svilake.com/transfer-shatsk',
      },
      {
        property: 'og:image',
        content:
    ...
    link: [
      {
        hid: 'canonical',
        rel: 'canonical',
        href: 'https://www.svilake.com/transfer-shatsk',
      },
    ],
  },
  methods: {
